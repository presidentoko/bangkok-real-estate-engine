...
// Closed set — getViableStations() is the single source of truth for which
// stations get a page (see lib/queries/stations.ts); anything it excludes is
// "not viable" by design, and anything not returned at all is nonexistent.
// Without this, Next renders the notFound() boundary for unlisted params but
// still ships it as HTTP 200 (on-demand ISR fallback doesn't propagate 404
// status correctly). dynamicParams=false makes Next 404 at the router level.
