...
export default async function ThailandRetireeGuide({
  ...
  return (
    <main className="max-w-3xl mx-auto p-6">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: jsonLdString(blogBreadcrumbs(lang, SLUG, t.h1)) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: jsonLdString(buildFaqJsonLd(FAQS)) }} />
